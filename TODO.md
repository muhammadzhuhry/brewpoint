...
- [ ] **Categories** — list, create, update, delete (`use-categories.ts` already built above, pulled forward — just needs create/update/delete mutations and the page wired)
